...
$(document).ready(function() {
	...
	$('#modulation_table tbody').on( 'click', 'td i', function (e) {
	...
	$('#modulation_table').DataTable( {
		dom: "Bfrtip",
		ajax: "./staff.php",
		columns: [
			{ data: "id", },
			{ data: "modulation",  render: editIcon },
		],
		select: true,
		buttons: [
...
<body class="dt-example dt-example-bootstrap4">
	<div class="container">
		<section>
			...
			<table id="modulation_table" class="ditable table-striped table-borderedsplay">
				<thead>
					<tr>
						<th>ID</th>
						<th>Modulation Name</th>
					</tr>
				</thead>
				<tbody/>
			</table>

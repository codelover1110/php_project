...
$(document).ready(function() {
	...
	$('#discoverers_talbe tbody').on( 'click', 'td i', function (e) {
	...
	$('#discoverers_talbe').DataTable( {
		dom: "Bfrtip",
		ajax: "./staff.php",
		columns: [
			{ data: "id", },
			{ data: "discoverer",  render: editIcon },
		],
		select: true,
		buttons: [
...
<body class="dt-example dt-example-bootstrap4">
	<div class="container">
		<section>
			...
			<table id="discoverers_talbe" class="ditable table-striped table-borderedsplay">
				<thead>
					<tr>
						<th>ID</th>
